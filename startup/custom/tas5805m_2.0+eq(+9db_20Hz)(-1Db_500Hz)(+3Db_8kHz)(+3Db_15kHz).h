...
// RESET
    ...
    { 0x7f, 0xaa },
    { 0x00, 0x24 },
    { 0x18, 0x08 }, //  Biquad -  BQ1 Left   -     Filter: Equalizer (Q Factor)  Frequency: 20 Hz  Gain: 9dB  QVal: 1  Bandwidth: 1000 Hz
    { 0x19, 0x02 },
    { 0x1a, 0x6f },
    { 0x1b, 0x90 },
    { 0x1c, 0xf0 },
    ...
    { 0x3e, 0xa0 },
    { 0x3f, 0xd1 },
    { 0x40, 0x09 }, //  Biquad -  BQ3 Left   -     Filter: Equalizer (Q Factor)  Frequency: 15000 Hz  Gain: 3dB  QVal: 1  Bandwidth: 1000 Hz
    { 0x41, 0x16 },
    { 0x42, 0x2d },
    { 0x43, 0x83 },
    { 0x44, 0xfa },
    ...
    { 0x52, 0x9e },
    { 0x53, 0x35 },
    { 0x54, 0x07 }, //  Biquad -  BQ4 Left   -     Filter: Equalizer (Q Factor)  Frequency: 500 Hz  Gain: -1dB  QVal: 0.1  Bandwidth: 1000 Hz
    { 0x55, 0xdd },
    { 0x56, 0x74 },
    { 0x57, 0x1f },
    { 0x58, 0xf2 },
