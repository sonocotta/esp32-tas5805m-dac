...
// RESET
    ...
    { 0x7f, 0x8c },
    { 0x00, 0x2b },
    { 0x34, 0x00 }, //   DRC Settings of band1:   attack: 25 ms, release: 50 ms, energy: 25 ms, Region1 - Threshold: -124 dB, Offset: 0 dB, Ratio: 0.52   Region2 - Threshold: -100.78 dB, Offset: 21.55 dB, Ratio: 1.27   Region3 - Threshold: 0 dB, Offset: 0 dB, Ratio: 100
    { 0x35, 0x0d },
    { 0x36, 0xa6 },
    { 0x37, 0x86 },
    { 0x38, 0x00 },
