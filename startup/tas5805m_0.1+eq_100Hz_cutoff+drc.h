...
// RESET
    ...
    { 0x7f, 0xaa },
    { 0x00, 0x24 },
    { 0x18, 0x00 }, //  Biquad -  BQ1 Left   -     Filter: Low Pass-ButterWorth 2  Frequency: 100 Hz  Gain: 3dB  QVal: 0.71  Bandwidth: 1000 Hz
    { 0x19, 0x00 },
    { 0x1a, 0x07 },
    { 0x1b, 0xe5 },
    { 0x1c, 0x00 },
    ...
    { 0x2a, 0xde },
    { 0x2b, 0x6c },
    { 0x2c, 0x00 }, //  Biquad -  BQ2 Left   -     Filter: Low Pass-ButterWorth 2  Frequency: 100 Hz  QVal: 0.71  Bandwidth: 1000 Hz
    { 0x2d, 0x00 },
    { 0x2e, 0x05 },
    { 0x2f, 0x97 },
    { 0x30, 0x00 },
    ...
    { 0x7f, 0x8c },
    { 0x00, 0x2b },
    { 0x34, 0x00 }, //   DRC Settings of band1:   attack: 25 ms, release: 50 ms, energy: 25 ms, Region1 - Threshold: -124 dB, Offset: 22.24 dB, Ratio: 1   Region2 - Threshold: -102.13 dB, Offset: 22.24 dB, Ratio: 1.28   Region3 - Threshold: 0 dB, Offset: 0 dB, Ratio: 100
    { 0x35, 0x0d },
    { 0x36, 0xa6 },
    { 0x37, 0x86 },
    { 0x38, 0x00 },
